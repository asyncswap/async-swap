...
contract ScriptHelper is Script {
    ...
    function _broadcastPath(string memory scriptName) internal view returns (string memory) {
    ...
    function _readDeployedContractAddress(string memory scriptName, uint256 txIndex) internal view returns (address) {
